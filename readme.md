...
- [Lockpicking](https://github.com/meitar/awesome-lockpicking) - The art of unlocking a lock by manipulating its components without the key.
 - [Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) - The automated software testing technique that involves providing invalid, unexpected, or random data as inputs to a computer program.
